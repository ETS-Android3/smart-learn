package com.smart_learn.presenter.helpers.fragments.test_types;
...
public abstract class BasicTestTypeFragment <VM extends BasicTestTypeViewModel> extends BasicFragment<VM> {
    ...
    public void onResume() {
        super.onResume();
        Utilities.Activities.resetToolbarTitle((AppCompatActivity) requireActivity(), getString(R.string.test));
