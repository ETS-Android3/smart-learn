...
public abstract class LessonViewModel extends AndroidViewModel {
    ...
    public DialogFragment prepareLessonDialog(boolean update, final Lesson lesson){
        ...
        return new LessonDialog(lesson,true, title, R.string.save, R.string.cancel, new DialogActionsCallback() {
