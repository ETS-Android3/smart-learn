package com.smart_learn.presenter.user.activities.test.fragments.online_test_container.fragments.test_types.test_full_write;
...
import com.smart_learn.presenter.common.fragments.test.test_types.full_write.FullWriteTestViewModel;
...
public class UserFullWriteOnlineTestViewModel extends FullWriteTestViewModel {

    private DocumentSnapshot extractedTestSnapshot;

    public UserFullWriteOnlineTestViewModel(@NonNull @NotNull Application application) {
        super(application);
    }
        ...
        TestService.getInstance()
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<DocumentSnapshot> task) {
                        ...
                        fragment.requireActivity().runOnUiThread(() -> UserFullWriteOnlineTestViewModel.super.setExtractedTest(fragment, test, true));
                    }
                });
