...
public class UserTrueOrFalseTestViewModel extends TrueOrFalseTestViewModel {

    private DocumentSnapshot extractedTestSnapshot;

    public UserTrueOrFalseTestViewModel(@NonNull @NotNull Application application) {
        super(application);
    }
        ...
        TestService.getInstance()
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<DocumentSnapshot> task) {
                        ...
                        fragment.requireActivity().runOnUiThread(() -> UserTrueOrFalseTestViewModel.super.setExtractedTest(fragment, test, false));
                    }
                });
