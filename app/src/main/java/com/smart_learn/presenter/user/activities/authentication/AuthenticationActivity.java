package com.smart_learn.presenter.user.activities.authentication;
...
import com.smart_learn.presenter.common.dialogs.LoadingDialog;
...
public class AuthenticationActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.toolbarActivityAuthentication);
