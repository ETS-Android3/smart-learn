package com.smart_learn.presenter.guest.activities.test.fragments.test_types.quiz;
...
import com.smart_learn.presenter.common.fragments.test.test_types.quiz.QuizTestViewModel;
...
public class GuestQuizTestViewModel extends QuizTestViewModel {

    public GuestQuizTestViewModel(@NonNull @NotNull Application application) {
        super(application);
    }
