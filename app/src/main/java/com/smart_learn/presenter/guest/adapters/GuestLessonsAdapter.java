package com.smart_learn.presenter.guest.adapters;
...
import com.smart_learn.presenter.common.adapters.helpers.BasicListAdapter;
...
public class GuestLessonsAdapter extends BasicListAdapter<Lesson, GuestLessonsAdapter.LessonViewHolder, GuestLessonsAdapter.Callback> implements Filterable, PresenterHelpers.AdapterHelper {
    ...
    public final class LessonViewHolder extends BasicViewHolder<Lesson, LayoutCardViewLessonBinding> {
        ...
        @Override
        public Lesson getEmptyLiveItemInfo() {
            return Lesson.generateEmptyObject();
        }

        @Override
        public void bind(@NonNull @NotNull Lesson item, int position) {
            ...
            String extraDescription = adapterCallback.getFragment().getString(R.string.lesson_added) + " " +
