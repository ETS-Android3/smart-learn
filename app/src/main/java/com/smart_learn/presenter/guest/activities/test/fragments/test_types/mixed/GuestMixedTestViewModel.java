package com.smart_learn.presenter.guest.activities.test.fragments.test_types.mixed;
...
public class GuestMixedTestViewModel extends MixedTestViewModel {

    public GuestMixedTestViewModel(@NonNull @NotNull Application application) {
        super(application);
    }
