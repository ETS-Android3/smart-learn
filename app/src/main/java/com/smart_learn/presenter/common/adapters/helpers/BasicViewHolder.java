package com.smart_learn.presenter.common.adapters.helpers;
...
public abstract class BasicViewHolder<T, BI extends ViewDataBinding> extends RecyclerView.ViewHolder {
     ...
     * */
    public abstract T getEmptyLiveItemInfo();
     ...
     * */
    public abstract void bind(@NonNull @NotNull T item, int position);
}